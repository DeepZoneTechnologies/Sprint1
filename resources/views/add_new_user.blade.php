        ...
        <div class="Mainbody_content mtop pbottom">
          <div class="Mainbody_content_nav_header d-flex">
            ...
            <ul class="path_nav">
              ...
              <li><a href="#" class="active"> Daftar Pengguna Baharu</a></li>
            </ul>
          </div>
                                ...
                                <div class="col-xl-12 col-lg-12">
                                           <div class="card card-h-100">
                                                ...
                                                <div class="userlist_content_header_left d-flex">
                                                  <img
                                                    src="assets/images/New_Register.png"
                                                    alt="card"
                                                    class="iconer"
                                                  />
                                                  <h3>Daftar Baharu</h3>
                                               ...
                                               <div class="card-header user_register_tab_container justify-content-between align-items-center">
                                                <label for="Kategori_Pengguna" class="radio_label" style="color: #646c9a"
                                                    ...
                                                    <label class="r_container" for="pengguna_jps"
                                                        >Pengguna JPS
                                                        <input type="radio" id="pengguna_jps" name="kategori" value="1" checked />
                                                        <span class="checkmark"></span>
                                                    </label>

                                                    <label class="r_container" for="agensi_luar"
                                                        >Agensi Luar
               ...
               <div class="row p-4">
                  <div class="col-12">
                     <div class="page-title-box">
                           ...
                           {{-- <h3 class="page-title ">Selenggara Data</h3>
                     </div>
                  </div>
                  <form action="" method="post" id="create_user_form" name="myform">
                     <input type="hidden" id="api_url" value={{env('API_URL')}}>
                     ...
                     <div class="card  mb-0">
                        <button type="button" class="close border-0 bg-white text-right" data-dismiss="modal" aria-label="Close">
                           ...
                           <div class="modal-body text-center" id="user_pop-up">
                              ...
                              <button class="btn  close" id="tutup" style="background-color: #5B63C3 !important;float:none;">Tutup</button>
                           </div>
                        <div>
                        </div>               
                     </div> <!-- end card-->
