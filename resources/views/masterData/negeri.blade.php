          ...
          >
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="negeriForm"   role="form">
                <div class="form-group">
                    <label for="nama">Kod</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
...
$(document).ready(function () {   
    ...
    $("#negeriForm").submit(function(event){
		submitNegeriForm();
		return false;
	});
    function submitNegeriForm(){
        //console.log(document.lookup.name.value)
        var formEl = document.forms.negeriForm;
